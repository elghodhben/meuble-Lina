...
<!-- banner -->
                        <div class="box-body">
                            ...
                            <tr><td style="color:green;"><?php echo"Salut cher client : ".$_SESSION['client']['prenom']." ".$_SESSION['client']['nom']; ?></td></tr>
                            </table>
                        </div>
<div class="box-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                $requete = "SELECT * FROM reclammation where mail='$mail'";
                                $result = $idcom->query($requete);
                                $count=mysqli_num_rows($result);
                                if (!$count) {
                                    echo "<tr>";
                                    echo "<td>pas de reclamation pour le momment</td>";
                                    echo "</tr>";
                                } else {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td><b> $row[message] </td>";
                                        if($row['reponce']!="")
                                        {
                                            echo "<td> $row[reponce] </td>";
										
                                       
                                        }
                                        else
                                        {
                                        echo "<td> pas de réponce  </td>";
                                        }
                                        echo "</tr>";
