                ...
                <div class="module form-module">
                    ...
                    <div class="form">
                        ...
                        <form action="ajouterentreprise.php" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" name="nom_res" placeholder="Nom responsable" pattern="[a-zA-Z-\.\' ']{3,20}" required=" ">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" name="nom_ese" placeholder="Nom de l'entreprise" pattern="[a-zA-Z-\.\' ']{3,20}"
                                           required=" ">
                                </div>
                                <div class="col-md-6">
                                    <input type="email" name="email_ese" placeholder="Email"
                                           pattern="^[a-z0-9._-]+@[a-z0-9._-]+\.[a-z]{2,6}" required=" ">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" name="tel_ese" placeholder="téléphone" pattern="[0-9]{8,14}" required=" ">
                                </div>

                                <div class="col-md-6">
                                    <input type="password" name="mdp_ese" placeholder="mot de passe" pattern="[0-9a-zA-Z-\.]{6,20}"
                                           required=" ">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <textarea id="adr" name="adr_ese"
                                              rows="5" cols="33" placeholder="Adresse..." pattern="[0-9a-zA-Z-\.]{6,50}"
                                              required=" "></textarea>
                                </div>
                            </div>
